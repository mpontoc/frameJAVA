...
public class Log {
	...
	public static String getCallerClassName() { 
		...
		for (int i = 1; i < elements.length; i++) {
			if (!elements[i].getClassName().equals(Log.class.getName()) && !elements[i].getClassName().equals(Functions.class.getName()) && elements[i].getClassName().indexOf("java.lang.Thread")!= 0) {
